...
const ConfirmDelete = ({show, closeModal, title, message, onClick}) => {
    ...
    return (
        ...
        >
            ...
            <div className="mt-5 sm:mt-6 flex space-x-2">
                <button
                    type="button"
                    className="inline-flex w-full justify-center rounded-md border   px-3 py-2 text-sm font-semibold text-white bg-red-600 shadow-sm "
                    onClick={closeModal}
                >
                    Terug
                </button>
